...
function Signal(props) {
 ...
 function navigateMaster(direction){
  ...
  <path class="st4" d="M 281.44 702.344 L 279.94 702.344 L 279.94 102.044 C 279.94 84.744 265.94 70.744 248.54 70.744 C 231.24 70.744 217.24 84.744 217.24 102.044 L 217.24 189.344 L 215.84 189.344 L 215.84 102.044 C 215.84 83.944 230.54 69.244 248.64 69.244 C 266.74 69.244 281.44 83.944 281.44 102.044 L 281.44 702.344 Z" style={{fill: 'rgb(153, 153, 153)'}}/>
  ...
  <circle onClick={() => { navigateMaster('left'); }} class="st5" cx="215.829" cy="128.748" r="10.5" style={{fill: `${leftSignalColor}`}}/>
  <circle onClick={() => { navigateMaster('right');  }} class="st6" cx="215.829" cy="157.548" r="10.5" style={{fill: `${rightSignalColor}`}}/>
  <circle class="st6" cx="215.829" cy="186.248" r="10.5" style={{fill: `${bottomSignalColor}`}}/>
